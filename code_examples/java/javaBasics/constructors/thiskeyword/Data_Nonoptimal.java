package com.revature.javaBasics.constructors.thiskeyword;

/*
 * This class is used to showcase the benefit of using the
...
public class Data_Nonoptimal {
    ...
    /*
      * Notice that the implementation here is a bit different
      * from the other constructors. This is a bug! and may be
      * difficult to trace!
     */
