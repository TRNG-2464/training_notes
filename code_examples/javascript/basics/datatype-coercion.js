...
*/
let value = numWord * 5;    // This mathmatic operation will cause JavaScript to attempt
                            // Type coercion - trying to change the "10" string into a number
console.log ("'10' * 5");
...
/*
    Keep in mind that the '+' operator does NOT coerce to a number when a String value is present. 
    If a String is present, other values will instead be coerced to a String.
*/
let sum = numWord + 5;
console.log ("'10' + 5");
console.log(sum); // prints "105". Since "10" is a String, it will concatenate (append) 5 to 
                    // the end of the string, i.e. "10" followed by "5". "105".
...
console.log(true === (10 > 5));     // No type coercion. This will print true
