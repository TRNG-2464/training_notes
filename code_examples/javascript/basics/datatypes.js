...
console.log(sym1 === sym2); // false — each Symbol() call is unique
dataDetails(sym1);  // Note: You cannot convert a Symbol to a string. So this throws an error.
                    // This is because Symbols are meant to be unique identifiers, and not meant to be converted to strings.

// Common use case: using a Symbol as a "hidden" object key
const secretKey = Symbol("secret");
const user = {
  name: "Alex",
  [secretKey]: "Internal data not meant for normal iteration",
};