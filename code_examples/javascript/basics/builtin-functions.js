...
/*
    Note: by default the prompt function will return a String, so 
    if you want to use the input as a number, you will need to convert 
    it to a number using the Number() function.
*/
